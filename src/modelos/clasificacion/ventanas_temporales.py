...
def seleccionar_modelo(y_train):
    ...
    opcion = input("Elige el modelo a entrenar (1/2/3): ")
...
def main():
    ...
    print("Calculando ventanas espacio-temporales.")
    df_features = crear_features_temporales(df_completo, radio_km=10, ventana_dias=7)
    ...
    clf, model_name = seleccionar_modelo(y_train)
    ...
    run = wandb.init(
        entity=WANDB_ENTITY,
        name=f"{model_name} Experimento Temporal",
